...
import 'package:we_rate_dogs/movie/views/peopledetail_page/components/header_component/component.dart';
import 'package:we_rate_dogs/movie/views/peopledetail_page/components/header_component/state.dart';
import 'package:we_rate_dogs/movie/views/peopledetail_page/components/knownfor_component/component.dart';
import 'package:we_rate_dogs/movie/views/peopledetail_page/components/knownfor_component/state.dart';
import 'package:we_rate_dogs/movie/views/peopledetail_page/components/personalinfo_component/component.dart';
import 'package:we_rate_dogs/movie/views/peopledetail_page/components/personalinfo_component/state.dart';
import 'package:we_rate_dogs/movie/views/peopledetail_page/components/timeline_component/component.dart';
import 'package:we_rate_dogs/movie/views/peopledetail_page/components/timeline_component/state.dart';
