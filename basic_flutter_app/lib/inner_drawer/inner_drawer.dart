...
class InnserDrawerHomePage extends StatefulWidget {
  InnserDrawerHomePage({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<InnserDrawerHomePage> {
  ...
  Widget build(BuildContext context) {
    return InnerDrawer(
        key: _innerDrawerKey,
        position:
            _position ? InnerDrawerPosition.start : InnerDrawerPosition.end,
              ...
              ListView(
                children: <Widget>[
                  Material(
                      ...
                      child: Padding(
                          padding:
                              EdgeInsets.only(top: 12, bottom: 10, left: 15),
                          child: Row(
