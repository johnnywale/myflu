...
import 'package:we_rate_dogs/pages/video/player_widget.dart';
...
class _ExampleAppState extends State<AudioExampleApp> {
  ...
  Widget localAsset() {
    return _tab([
      ...
      _btn('Play', () => audioCache.play('audio/audio.mp3')),
      Text('Loop Local Asset \'audio.mp3\':'),
      _btn('Loop', () => audioCache.loop('audio/audio.mp3')),
      Text('Play Local Asset \'audio2.mp3\':'),
      _btn('Play', () => audioCache.play('audio/audio2.mp3')),
      ...
      _btn('Play',
          () => audioCache.play('audio/audio2.mp3', mode: PlayerMode.LOW_LATENCY)),
      getLocalFileDuration(),
    ]);
  }

  Future<int> _getDuration() async {
    File audiofile = await audioCache.load('audio/audio2.mp3');
  ...
  Widget notification() {
    return _tab([
      ...
      _btn(
          'Play', () => audioCache.play('audio/messenger.mp3', isNotification: true)),
    ]);
  }
