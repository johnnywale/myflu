...
part of 'paged_calendar_event.dart';

// **************************************************************************
// JaguarSerializerGenerator
// **************************************************************************

abstract class _$PagedCalendarEventSerializer
    implements Serializer<PagedCalendarEvent> {
  Serializer<CalendarEvent> __calendarEventSerializer;
  Serializer<CalendarEvent> get _calendarEventSerializer =>
      __calendarEventSerializer ??= CalendarEventSerializer();
  @override
  Map<String, dynamic> toMap(PagedCalendarEvent model) {
    ...
    setMapValue(
        ret,
        'data',
        codeIterable(model.data,
            (val) => _calendarEventSerializer.toMap(val as CalendarEvent)));
    return ret;
  }

  @override
  PagedCalendarEvent fromMap(Map map) {
    if (map == null) return null;
    final obj = PagedCalendarEvent(
        ...
        data: codeIterable<CalendarEvent>(map['data'] as Iterable,
                (val) => _calendarEventSerializer.fromMap(val as Map)) ??
            getJserDefault('data'));
    return obj;
  }
}
